...
class OffersOnetime extends Component {
	...
	renderIcon (item) {
		if (item.pointsTwo === '$1') {
			return <Text><Image style={styles.iconStyle} source={rewardScrollImages['bolt']} /><Text style={styles.boldStyle}> {item.pointsOne}</Text><Text> per </Text><Text style={styles.boldStyle}>{item.pointsTwo}</Text><Text> spent</Text></Text>;
		}
