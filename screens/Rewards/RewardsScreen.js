...
class RewardsScreen extends Component {
    static navigationOptions = {
        ...
        headerLeft: (
            <Image
                source={require('../../images/max-logo.png')}
                style={{
                    width: 30,
                    height: 30,
    ...
    render() {
        ...
        return (
            <ScrollView style={styles.scrollView}>
                ...
                <ScreenSeparator />
                <View>
                    <Text style={styles.textStyle}>SEARCH BY BRAND</Text>
                    <ScreenLineSeparator />
                    <RewardBrands searchReward={rewardSearchData} />
                </View>
                <ScreenSeparator />
                <View>
                    <Text style={styles.textStyle}>AVAILABLE REWARDS</Text>
                    <ScreenLineSeparator />
                    <FlatList
...
export default connect(mapStateToProps, { homeRewardsFetch, homeOffersFetch })(
    RewardsScreen
);
